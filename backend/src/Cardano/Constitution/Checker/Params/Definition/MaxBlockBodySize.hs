...
maxBlockBodySize =
  Scalar @Integer
    ...
    , ("MBBS-05", "*maxBlockBodySize* **should** be changed by at most 10,240 Bytes (10KB) per epoch (5 days), and preferably by 8,192 Bytes (8KB) or less per epoch") `ShouldSatisfy` \ctx val -> Neutral "Please contribute to the check"
