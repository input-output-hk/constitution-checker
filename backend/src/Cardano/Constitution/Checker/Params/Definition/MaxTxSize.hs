...
maxTxSize =
  Scalar @Integer
    ...
    , ("MTS-05", "*maxTxSize* **should not** be increased by more than 2,560 Bytes (2.5KB) in any epoch, and preferably **should** be increased by 2,048 Bytes (2KB) or less per epoch") `ShouldSatisfy` \ctx val -> 
